  ...
  "fixed inset-x-0 z-50 flex border bg-background !outline-none",
  {
    variants: {
      variant: {
        ...
        right: "ml-24 right-0 top-0 h-screen w-fit rounded-l-[10px] [&>div.handle]:my-auto [&>div.handle]:ml-2 [&>div.handle]:w-2 [&>div.handle]:h-[100px] [&>div>div.drawer-nav]:pl-4",
        left: "mr-24 left-0 top-0 h-screen w-fit flex-row-reverse rounded-r-[10px] [&>div.handle]:my-auto [&>div.handle]:mr-2 [&>div.handle]:w-2 [&>div.handle]:h-[100px] [&>div>div.drawer-nav]:pr-4",
      },
    },
    defaultVariants: {
      variant: "bottom",
